...
<link rel="stylesheet" href="styleDiv.css" type="text/css">
  ...
  <div class="fullbg">
    ...
    <div class="row">
      ...
      <div class="col-md-2 col-md-offset-5 col-sm-6 col-sm-offset-3 col-xs-8">
        ...
        <h1 class="logo" style="width: 350px;">Onde se Divertir</h1>
      ...
      <div class="col-md-8 col-md-offset-2 col-xs-12 text-center text-banner">
        ...
        <h2>Os melhores lugares para se divertir na</h2>
...
<?php
  ...
  $banco = new DataBase();
  $result = $banco->query("select * from diversao");
...
<div class="container-fluid footer section-container">
  ...
  <div class="row">
    <div class="col-md-12">
      <form action="cadastroDiv.php" method="POST" enctype="multipart/form-data" name="cadastro" >
        ...
        <div class="col-md-6">
          ...
          ?>
          <span class="header-text">Cadastro de Variedades</span>
          <br>
