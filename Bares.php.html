...
<link rel="stylesheet" href="styleBar.css" type="text/css">
  ...
  <div class="fullbg">
    ...
    <div class="row">
      ...
      <div class="col-md-8 col-md-offset-2 col-xs-12 text-center text-banner">
        ...
        <h2>Os melhores lugares para beber na</h2>
...
<?php
  ...
  $banco = new DataBase();
  $result = $banco->query("select * from bares");
...
<div class="container-fluid footer section-container">
  ...
  <div class="row">
    <div class="col-md-12">
      <form action="cadastroBar.php" method="POST" enctype="multipart/form-data" name="cadastro" >
        ...
        <div class="col-md-6">
          ...
          ?>
          <span class="header-text">Cadastro de Bares</span>
          <br>
