...
<link rel="stylesheet" href="styleBal.css" type="text/css">
  ...
  <div class="fullbg">
    ...
    <div class="row">
      ...
      <div class="col-md-2 col-md-offset-5 col-sm-6 col-sm-offset-3 col-xs-8">
        ...
        <h1 class="logo" style="width: 300px;">Onde Badalar </h1>
        ...
        <nav class="navi navbar navbar-default" role="navigation">
          ...
          <div class="menubox collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav menu">
              ...
              <li><a href="#">Casas Noturnas</a></li>

              <li><a href="#">Afters</a></li>

              <li><a href="#">Danceterias</a></li>
      ...
      <div class="col-md-8 col-md-offset-2 col-xs-12 text-center text-banner">
        ...
        <h2>Os melhores lugares para curtir na</h2>
...
<?php
  ...
  $banco = new DataBase();
  $result = $banco->query("select * from baladas");
...
<div class="container-fluid footer section-container">
  ...
  <div class="row">
    <div class="col-md-12">
      <form action="cadastroBal.php" method="POST" enctype="multipart/form-data" name="cadastro" >
        ...
        <div class="col-md-6">
          ...
          ?>
          <span class="header-text">Cadastro de Baladas</span>
          <br>
